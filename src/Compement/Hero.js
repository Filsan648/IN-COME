...
<p className=" px-2 w-max bg-black/60 backdrop-blur rounded-3xl text-white text-sm tracking-widest  shadow-lg">
  360° Creative Powerhouse
</p>


    <h1 className="text-5xl w-full md:w-3/4 font-serif md:text-6xl font-extralight  leading-tight tracking-tight">
...
<div className="mt-6 flex pt-12 items-center gap-6">
</div>
